                ...
                <div class="dropdown">
                    <a class="topbar-link dropdown-toggle drop-arrow-none px-2" data-bs-toggle="dropdown"
                        ...
                        @if (auth('user')->user()->image)
                            <img src="{{ asset(auth('user')->user()->image) }}" width="32"
                        ...
                        <span class="d-lg-flex flex-column gap-1 d-none">
                            <h5 class="my-0">{{ auth('user')->user()->first_name }}
                                {{ auth('user')->user()->last_name }}</h5>
                            <h6 class="my-0 fw-normal">{{ auth('user')->user()->email }}</h6>
                        </span>
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <!-- item-->
                        <a href="{{ route('user.transfer_pin.index') }}" class="dropdown-item">
                            <i class="ti ti-pin me-1 fs-17 align-middle"></i>
                            <span class="align-middle">Set Transfer PIN</span>
                        </a>
