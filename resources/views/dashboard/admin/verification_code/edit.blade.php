    ...
    <div class="page-container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.verification.code.update', $verificationCode->uuid) }}" method="POST"
                            class="row">
                            @csrf
                            <div class="col-12">

                                <h4 class="mb-3">Edit {{ $verificationCode->name }} Verification Code</h4>

                                <div class="mb-3">
                                    <label for="name">Name *</label>
                                    <input type="text" id="name" name="name"
                                        value="{{ old('name', $verificationCode->name) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="description" name="description"
                                        value="{{ old('description', $verificationCode->description) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" id="length" name="length"
                                        value="{{ old('length', $verificationCode->length) }}"
