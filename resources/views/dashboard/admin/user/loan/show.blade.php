                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @if ($loan->status->value === 'pending')
                            <a href="{{ route('admin.user.loan.approve', [$user->uuid, $loan->uuid]) }}"
                                class="btn btn-success">Approve</a>

                            <a href="{{ route('admin.user.loan.reject', [$user->uuid, $loan->uuid]) }}"
                                class="btn btn-danger">Reject</a>
                        @endif

                        <div class="d-flex justify-content-end">
                            <a href="{{ route('admin.user.loan.index', $user->uuid) }}" class="btn btn-primary">Back</a>
                        </div>
